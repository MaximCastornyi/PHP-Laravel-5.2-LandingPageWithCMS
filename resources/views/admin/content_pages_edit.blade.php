...
{!! Form::open(['url' => route('pagesEdit',array('page'=>$data['id'])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
    <div class="form-group">
    	{!! Form::hidden('id', $data['id']) !!}
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('name', $data['name'], ['class' => 'form-control','placeholder'=>'Add page`s name']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('alias', $data['alias'], ['class' => 'form-control','placeholder'=>'Add page`s alias']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::textarea('text', $data['text'], ['id'=>'editor','class' => 'form-control','placeholder'=>'Add page`s name']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
	    <div class="col-xs-offset-2 col-xs-10">
	      {!! Form::button('Image', ['class' => 'btn btn-primary','type'=>'submit']) !!}
	    </div>
	  </div>
